...
type Permission =
  ...
  | 'tasks.read' | 'tasks.write' | 'deals.read' | 'deals.write' | 'settings.write';

export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  admin: ['clients.read','clients.write','projects.read','projects.write','tasks.read','tasks.write','deals.read','deals.write','settings.write'],
